...
public class InputCarQueue extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    InputCarQueue frame = new InputCarQueue();
     ...
     * Create the frame.
     */
    public InputCarQueue() {
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setBounds(100, 100, 500, 392);
        contentPane = new JPanel();
        contentPane.setBorder(new TitledBorder("INPUT CAR QUEUE"));
        ...
        txtTarget.setBounds(10, 123, 470, 20);
        ...
        btnSend.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    ...
                    DataToSend.petriObject = tempQueue;
