...
public class Functions implements Serializable {
	...
	public boolean HaveBusForMe(PetriTransition t, ArrayList<DataCar> list) {
		if (list == null)
			return false;
		if (t == null)
			return false;
		for (int i = 0; i < list.size(); i++) {
			if (list.get(i) != null && list.get(i).Value != null && list.get(i).Value.isBus)
				if (list.get(i).Value.Targets.contains(t.TransitionName))
					return true;
		}
		return false;
	...
	public boolean HaveTramForMe(PetriTransition t, ArrayList<DataCar> list) {
		if (list == null)
			return false;
		if (t == null)
			return false;
		for (int i = 0; i < list.size(); i++) {
			if (list.get(i) != null && list.get(i).Value != null && list.get(i).Value.isTram)
				if (list.get(i).Value.Targets.contains(t.TransitionName))
					return true;
		}
		return false;
	...
	public boolean HaveTram(PetriTransition t, ArrayList<DataCar> list) {
		if (list == null)
			return false;
	...
	public boolean IsTram(PetriTransition t, DataCar car) {
		if (car == null)
			return false;
