...
public class ControllerPedestriansCrossing {
    ...
    public static void main (String []args) {
        ...
        DataString UserReq_Cross_V = new DataString();
        UserReq_Cross_V.SetName("UserReq_Cross_V");
        pn.PlaceList.add(UserReq_Cross_V);
        ...
        p6.SetName("P_Cross_TL_V_S2");
        p6.Value = new TransferOperation("localhost", "1080" , "P_Cross_TL_V_S2");
        pn.PlaceList.add(p6);

        DataTransfer p7 = new DataTransfer();
        p7.SetName("P_Cross_PTL_V_S2");
        p7.Value = new TransferOperation("localhost", "1080" , "P_Cross_PTL_V_S2");
        pn.PlaceList.add(p7);
        ...
        grdiniT.Activations.add(new Activation(iniT, "green", TransitionOperation.SendOverNetwork, "P_Cross_TL_V_S2"));
        grdiniT.Activations.add(new Activation(iniT, "red", TransitionOperation.SendOverNetwork, "P_Cross_PTL_V_S2"));
        ...
        t1.InputPlaceName.add("UserReq_Cross_V");

        Condition T1Ct1 = new Condition(t1, "wait", TransitionCondition.NotNull);
        Condition T1Ct2 = new Condition(t1, "UserReq_Cross_V", TransitionCondition.NotNull);
        T1Ct1.SetNextCondition(LogicConnector.AND, T1Ct2);

        GuardMapping grdT1 = new GuardMapping();
        grdT1.condition= T1Ct1;
        grdT1.Activations.add(new Activation(t1, "wait", TransitionOperation.Move, "yr"));
        grdT1.Activations.add(new Activation(t1, "yellow", TransitionOperation.SendOverNetwork, "P_Cross_TL_V_S2"));
        ...
        grdT2.Activations.add(new Activation(t2, "red", TransitionOperation.SendOverNetwork, "P_Cross_TL_V_S2"));
        grdT2.Activations.add(new Activation(t2, "green", TransitionOperation.SendOverNetwork, "P_Cross_PTL_V_S2"));
        ...
        grdT3.Activations.add(new Activation(t3, "yellow", TransitionOperation.SendOverNetwork, "P_Cross_PTL_V_S2"));
        ...
        grdT4.Activations.add(new Activation(t4, "red", TransitionOperation.SendOverNetwork, "P_Cross_PTL_V_S2"));
        grdT4.Activations.add(new Activation(t4, "green", TransitionOperation.SendOverNetwork, "P_Cross_TL_V_S2"));
