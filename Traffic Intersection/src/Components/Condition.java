		...
		switch (condition) {
			...
			case HaveBusForMe: {
				...
				if (Value1.GetValue() == null)
					return false;
				if (Value1.GetType() == PetriObjectType.DataCarQueue) {
					if (util.HaveBusForMe(Parent, ((CarQueue) Value1.GetValue()).Cars)) {
						return true;
					}
				}
				break;
			...
			case HaveTramForMe: {
				...
				if (Value1.GetValue() == null)
					return false;
				if (Value1.GetType() == PetriObjectType.DataCarQueue) {
					if (util.HaveTramForMe(Parent, ((CarQueue) Value1.GetValue()).Cars)) {
						return true;
					}
				}
				break;
			...
			case DontHaveTram: {
				...
				if (Value1.GetValue() == null)
					return true;
				if (Value1.GetType() == PetriObjectType.DataCarQueue) {
					if (!util.HaveTram(Parent, ((CarQueue) Value1.GetValue()).Cars)) {
						return true;
					}
				}
				break;
			...
			case IsTram: {
				...
				if (Value1.GetType() == PetriObjectType.DataCar) {
					if (util.IsTram(Parent, ((DataCar)Value1))) {
						return true;
					}
				}
				break;
